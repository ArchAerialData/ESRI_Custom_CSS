# ArcGIS Instant Apps - Basic (Media Map) CSS Context
...
- Template overview: https://doc.arcgis.com/en/instant-apps/latest/create-apps/basic.htm
...
This folder is a conservative starter for the Basic (Media Map) template because this repo has not yet live-inspected this app's DOM.
...
Inspect a live Basic (Media Map) app and capture the real selector map before adding any app-specific structural overrides.